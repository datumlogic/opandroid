...
namespace OpenPeerSdk
{
	namespace Helpers
	{
		// Taken from: http://ondevelopment.blogspot.ca/2008/01/generic-weak-reference.html
		// Alternative: http://www.codeproject.com/Articles/22363/Generic-WeakReference
		//
		/// <summary> 
