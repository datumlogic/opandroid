...
{
	[Activity (Label = "OpenPeerNativeSampleApp", MainLauncher = true)]
	public class MainActivity : Activity, LoginHandlerInterface
	{
		...
		private void setupAccountButton()
		{
			...
			accountButton.Click += delegate 
			{
				...
				//stack.Setup(ostackDelegate, mediaEngineDelegate, appID, appName, appImageURL, appURL, userAgent, deviceID, os, system);
			};
